...
export default function User(props) {
  ...
  const namesOfColumns = Object.keys(props.data[0]).filter(name => name !== "id" && name !== "user_id" 
  ...
  return (
      <div>
        <Header 
          ...
          goingTo={"userPage"}
        />
        <span><p className="fw-lighter text-muted">This stats is gotten from your saved jobs</p></span>
        <Table 
