...
export default function Table(props) {
  ...
  useEffect(() => {
    ...
    props.filteredData.forEach((data, index) => {
      setSeeDetails(oldArray => [...oldArray, {
        "index": index,
        "value": false
      }])
    })
  ...
  const handleClick = (index) => {
    ...
    setSeeDetails(oldArray => {
      ...
      let changedArray = oldArray.map((item) => {
        return item.index === index ? {...item, value: !item.value} : item
      })
  ...
  const filteredElements = props.filteredData.map(({ name, count, details }, index) => (
    <div className="table" key={index}>
      <div className="table-head" key={index}>
        <div className="number">
          <span>{(index+1).toString().length === 1 ? `0${index+1}` : index+1}</span>
        </div>
        ...
        <div className="table-body">
          ...
          {/* Experience component */
            ...
            <div className="component">
              ...
              <div className="metrics">
                {
                  details.filter(({category}) => category === "experience")
                  .map((item, id) => (
                    <p key={id}>
          ...
          {/* Location component */
            ...
            <div className="component">
              ...
              <div className="metrics">
                {
                  details.filter(({category}) => category === "location")
                  .map((item, id) => (
                    <p key={id}>
                      <span>{item.value}</span>
                      <span className="count">x{item.count}</span>
          ...
          {/* Technology component */
            ...
            <div className="component">
              ...
              <div className="metrics">
                {
                  details.filter(({category}) => category === "technology")
                  .map((item, id) => (
                    <p key={id}>
                      <span>{item.value}</span>
                      <span className="count">x{item.count}</span>
          ...
          {/* Job Type component */
            ...
            <div className="component">
              ...
              <div className="metrics">
                {
                  details.filter(({category}) => category === "job_type")
                  .map((item, id) => (
                    <p key={id}>
                      <span>{item.value}</span>
                      <span className="count">x{item.count}</span>
          ...
          {/* Role component */
            ...
            <div className="component">
              ...
              <div className="metrics">
                {
                  details.filter(({category}) => category === "role")
                  .map((item, id) => (
                    <p key={id}>
                      <span>{item.value}</span>
                      <span className="count">x{item.count}</span>
          ...
          {/* Price Range component */
            ...
            <div className="component">
              ...
              <div className="metrics">
                {
                  details.filter(({category}) => category === "price_range")
                  .map((item, id) => (
                    <p key={id}>
                      <span>{item.value}</span>
                      <span className="count">x{item.count}</span>
